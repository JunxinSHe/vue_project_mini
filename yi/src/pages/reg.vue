              ...
              <input type="hidden" name="type" v-model="account_type">
                ...
                <div class="ydc-reg-form-group clearfix">
  							...
  							<div class="ydc-reg-form-group clearfix">
  								<label>姓名:</label>
  								<div class="ydc-reg-form-input">
  									<input type="text" id="user1" name="name" class="ydc-form-control" autocomplete="off" placeholder="" value="lina">
  								</div>
  							</div>
  							<div class="ydc-reg-form-group clearfix">
  								<label>身份证号:</label>
  								<div class="ydc-reg-form-input clearfix">
  									<input type="text" id="user2" name="identify_number" class="ydc-form-control" autocomplete="off" placeholder="" value="122222">
  									<div class="ydc-reg-form-text">
  							...
  							<div class="ydc-reg-form-group clearfix">
  								<label>邮箱:</label>
  								<div class="ydc-reg-form-input">
  									<input type="text" id="user5" name="email" class="ydc-form-control" autocomplete="off" placeholder="" value="jin@aaa.com">
  								</div>
  								<div class="ydc-reg-form-text">
  							...
  							<div class="ydc-reg-form-group clearfix">
  								<label>QQ/微信号:</label>
  								<div class="ydc-reg-form-input">
  									<input type="text" id="user6" name="qq_wx" class="ydc-form-control" autocomplete="off" placeholder="" value="88888">
  								</div>
  								<div class="ydc-reg-form-text">
